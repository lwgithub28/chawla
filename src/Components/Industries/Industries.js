...
import Remoteservices from "../../Assests/Img/Remoteservices.webp";
import Deepexpertise from "../../Assests/Img/Deepexpertise.webp";
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="We offer industry-specific accounting, tax planning and financial advisory services for healthcare, real estate, retail, eCommerce, nonprofit organizations and more. " />
      </Helmet>
      <div className="fraunces" id="industries-page">
        ...
        <Banner
          ...
          description="Every industry has unique financial challenges; our expert CPAs help you navigate them with precision. At Chawla & Associates, we deliver industry-specific services for accounting, tax planning, and financial advisory to help your business thrive. Whether you are in healthcare, real estate, crypto, or any other sector, we ensure accuracy, efficiency, and strategic financial growth."
            ...
            <div className="row">
              <div class="top-middle-head remove-spacing">
                ...
                <h2 className="main-head">
                  Why Consider Our <b>CPA Services for Your Industry in Naperville?</b>
                </h2>
              </div>
              <div className="row why-us-boxes">
                <div className="col">
                  <div className="icon-box">
                    ...
                    <p>
                      With years of experience and a history of satisfied clients, we are trusted by businesses in Naperville to deliver exceptional results and peace of mind.
                    </p>
                  </div>
                </div>
                <div className="col">
                  <div className="icon-box">
                    ...
                    <p>
                      We understand the financial difficulties of real estate, healthcare, construction, retail, technology, and more.
                    </p>
                  </div>
                </div>
                <div className="col">
                  <div className="icon-box">
                    ...
                    <p>
                      Whether you’re a startup, SMB, or enterprise, our CPA solutions grow with your business.
                    </p>
                  </div>
                </div>
                <div className="col">
                  <div className="icon-box">
                    ...
                    <p>
                      We prioritize building long-term relationships, offering dedicated support and customized advice to help your business thrive.
                    </p>
                  </div>
                </div>
                <div className="col">
                  <div className="icon-box">
                    ...
                    <p>
                      As a Naperville-based firm, we understand the local business needs while adhering to global accounting standards for accuracy and compliance.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="container-fluid">
            <div className="row">
              <div className="col-lg-6 col-md-12 Connectwithusbgtext p-xs-0 padding-md-0">
                ...
                <h2 className="main-head">Your Industry Deserves Specialized CPA Services!</h2>
                <p className="text-desc">
                  Partner with our reliable <b>CPA firm in Naperville</b> and get proactive financial solutions tailored to your industry. Let’s create a smarter financial strategy!
