...
const AccountingServices = () => {
  return (
    <>
      <Helmet>
        <title>Innovative Small Business Accounting Services in Naperville</title>
        <meta name="description" content="Chawla & Associates CPAs offers bookkeeping, audit & assurance, payroll, financial statements and crypto accounting solutions for businesses like yours. Get personalized solutions today." />
      </Helmet>
      <div className="fraunces service-inner" id="taxes">
        ...
        <Banner
          ...
          description={
            <>
              Your goals as an individual and for your business are unique. Your financial plans must be a reflection of this. Our <b>small business accounting services</b> are tailored around you. As an award-winning accountancy firm offering a variety of accounting and advisory services to individuals and businesses in the U.S., we start by understanding your business so that we can offer customized services that help you succeed and take on new opportunities with confidence.
            </>
          }
            ...
            <div className="row">
              <div className="col-lg-5 col-md-12 Professionals-text">
                <span className="text">
                  ...
                  <h2 className="main-head">Accounting Services
                  </h2>
                </span>
              </div>
              <div className="col-lg-7 col-md-12 Professionals-text-desc p-xs-0 padding-md-0">
                <p className="text-desc">
                  Chawla & Associates is a full-service accounting firm offering a variety of services tailored to your needs. Our advisors and accountants have a thorough understanding of the accounting and tax challenges businesses face. That is why we offer personalized accounting services to keep you ahead of the curve.
                </p>
              </div>
            </div>
        ...
        {/* ---------------------------- */}
        {/* why choose us start */}
        <section id="why-choose-us" className="right-img-section mobile-spacing tablet-spacing">
          <div className="container-fluid">
            <div className="row">
              <div className="col-lg-7 col-md-12 col-sm-12 left-text padding-md-0">
                ...
                <p className="text-desc">
                  From administrative support to process optimization and compliance management, we are happy to offer you the foundational assistance that helps your business thrive. Allow us to streamline operations and help you attain your goals efficiently.
                </p>
                <ul className="check-list">
                  <li>
                    <IoCheckmarkSharp />
                    <span>Business Planning</span>
                    <p>Strategic guidance to help you define goals, make smart decisions, and build a roadmap for sustainable growth.</p>
                  </li>
                  <li>
                    <IoCheckmarkSharp />
                    <span>Assistance with Bank Financing</span>
                    <p>We help you prepare the right documents, strengthen your proposal, and navigate the financing process to secure the funding your business needs.</p>
                  </li>
                  <li>
                    <IoCheckmarkSharp />
                    <span>Office Lease Negotiations</span>
                    <p>We assist in reviewing terms, negotiating favorable conditions, and securing lease agreements that align with your business needs and budget.</p>
                  </li>
                  <li>
                    <IoCheckmarkSharp />
                    <span>Business Insurance</span>
                    <p>We guide you in selecting the right coverage to protect your business from risk, ensuring peace of mind and long-term security.</p>
                  </li>
                </ul>
              </div>
          ...
          <div className="container-fluid">
            <div className="row">
              <div className="col-lg-6 col-md-12 Connectwithusbgtext padding-md-0 p-xs-0">
                ...
                <h2 className="main-head">Have an Accounting Question? Ask Us</h2>
                <p className="text-desc">
                  We are the <b>best CPA in Naperville</b> offering accounting, audit, business advisory and tax services to clients across several industries and in all 50 states. We are here to position you for long-term growth. Connect with us today!
                </p>
