    ...
    return (
        <>
            <div className="AccountingInnerPage" id={contentData.mainid}>
                ...
                <section id='Bookkeeping-Accounting-Services' className='mobile-spacing tablet-spacing'>
                    <div className='container-fluid'>
                        <div className='row'>
                            <div className='col-md-7 col-lg-8 p-xs-0'>
                                <div class="Accounting-Services-inner-left">
                                    <img src={contentData.img} alt='BookkeepingAccountingServices' title='BookkeepingAccountingServices'></img>
                                </div>
                            </div>
                ...
                {/* ----------------------- */}
                {/* why choose us start */}
                <section id='outsouced-bookeeping' className='mobile-spacing tablet-spacing'>
                    <div className='container-fluid'>
                        <div className='row'>
                            <h3 class="sub-head p-xs-0 padding-md-0">/ Why Choose Us</h3>
                            <h2 class="main-head p-xs-0 padding-md-0">{contentData.WhyChooseUs.mainHead}</h2>
                            <p class="text-desc p-xs-0 padding-md-0">{contentData.WhyChooseUs.textDesc}</p>
                        </div>
                        ...
                        <ul className="check-list crypto-inner">
                            <div className='row'>
                                ...
                                <div className='col-md-6 p-xs-0'>
                                    <li>
                                        <IoCheckmarkSharp />
                                        <p>Amend prior-year tax returns to reflect cryptocurrency transactions</p>
                                    </li>
                                </div>
                                <div className='col-md-6 p-xs-0'>
                                    <li>
                                        <IoCheckmarkSharp />
                                        <p>Ensure compliance with federal, state and local tax regulations</p>
                                    </li>
                                </div>
                                <div className='col-md-6 p-xs-0'>
                                    <li>
                                        <IoCheckmarkSharp />
                                        <p>Ensure compliance with international regulations such as IRS Form 8938 and FBAR</p>
                                    </li>
                                </div>
                                <div className='col-md-6 p-xs-0'>
                                    <li>
                                        <IoCheckmarkSharp />
                                        <p>Offer accounting and reporting services for businesses that use digital currency</p>
                                    </li>
                                </div>
                            </div>
                        </ul>
                ...
                <section id='Financial-Audits' className='mobile-spacing tablet-spacing'>
                    <div className='container-fluid'>
                        <div className='row'>
                            <h2 class="main-head">Comprehensive Financial Audits, Reviews, and Preparations for Businesses</h2>
                            <p class="text-desc">
                                Successful businesses are built on the trust and assurance that their financial operations, internal controls and cash flows are sound and adhere to relevant laws and regulations. This is what makes accounting & auditing services in Naperville IL critical. When you come to us, our audit, compilation and review team will partner with you to uncover issues, help prevent fraud, avoid misappropriation of assets, as well as recommend best practices to improve profits and productivity.
                                <br></br><br></br>
                                At Chawla & Associates, we bring decades of experience in conducting audits, compilations, and reviews for businesses. As a trusted partner who takes pride in your success, we guarantee that all your audited financial statements adhere to GAAP (Generally Accepted Accounting Principles).
                                <br></br><br></br>
                                Trusting our team with audit and assurance services will boost the value, credibility as well as the consistency of your financial statements and internal controls. We offer great insight into your business’ processes to allow you to make more informed decisions, reduce cost of capital and enhance investor confidence.
                            </p>
                            <h4 className='audit-assurance-inner'>Our Expert Audit and Assurance Services</h4>
                            <ul className='check-list audit-assurance-inner'>
                                <div className='row'>
                                    <div className='col-md-6'>
                                        <li>
                                            <IoCheckmarkSharp />
                                            <p>Complete audits, reviews, compilations and preparations</p>
                                        </li>
                                    </div>
                                    <div className='col-md-6'>
                                        <li>
                                            <IoCheckmarkSharp />
                                            <p>Review and corroboration of assets
                                            </p>
                                        </li>
                                    </div>
                                    <div className='col-md-6'>
                                    ...
                                    <div className='col-md-6'>
                                        <li>
                                            <IoCheckmarkSharp />
                                            <p>Forensic accounting and embezzlement/fraud investigation</p>
                                        </li>
                                    </div>
                                    <div className='col-md-6'>
                                        <li>
                ...
                {/* ---------------------------- */}
                {/* how it works start */}
                <section id='bookkeeping-services' className='mobile-spacing tablet-spacing'>
                    <div className='container-fluid'>
                        <div className='row'>
                            <div className='col-sm-12 col-md-12 col-lg-12 bookkeeping-services-content p-xs-0 padding-md-0'>
                                ...
                                <h4 className='outsouced-bookeeping-inner'>You can trust us with:</h4>
                                <div className='row'>
                                    {contentData.HowItWorks.services.map((service, index) => (
                                        <div className={`col-md-6 ${service.className}`} key={index}>
                                            <div className='how-it-works-box'>
                                                <h2 className="main-head">{service.title}</h2>
                                                <p className="text-desc">{service.description}</p>
                                                <img src={boxesline} alt='boxesline' title='boxesline'></img>
                                            </div>
                                        </div>
                                    ))}
                ...
                {/* ------------------------ */}
                {/* Ask Us start */}
                <section id='ask-us' className='outsouced-bookeeping-inner bgimg mobile-spacing tablet-spacing'>
