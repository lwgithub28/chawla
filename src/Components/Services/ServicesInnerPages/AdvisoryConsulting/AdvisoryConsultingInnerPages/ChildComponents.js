    ...
    return (
        <>
            <div className="TaxInnerPage" id={contentData.mainid}>
                ...
                {/* -------------------- */}
                {/* nav start */}
                <section id='BusinessAdvisory' className='mobile-spacing tablet-spacing'>
                        ...
                        <div className='row'>
                                    ...
                                    <div class="Business-Advisory-inner-right">
                                        ...
                                        {contentData.sidebar.AllBtn.map((item, index) => (
                                            <div className={item.className}>
                                                <Link to={item.servicelink} key={index} className='Business-Advisory-inner-links'>
                                                    <p>{item.links}</p>
                            ...
                            <div className='col-md-7 col-lg-8 p-xs-0'>
                                <div class="Business-Advisory-inner-left">
                                    <img src={contentData.img} alt='Business Advisory Inner' title='Business Advisory Inner'></img>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            {contentData.TexthreePoints.map((point, index) => (
                                <div className="col-lg-4 col-md-6 p-xs-0" id={index}>
                                    <div class="Business-Advisory-box">
                                        <h2 class="main-head">{point.title}
                                        </h2>
                ...
                {/* --------------------------- */}
                {/*  Solutions start */}
                <section id='Business-Advisory-Solutions' className='Business-Advisory-Solutions mobile-spacing tablet-spacing'>
                    <div className='container-fluid p-xs-0'>
                        <div className='top-head padding-md-0 p-xs-0'>
                            ...
                            <p class="text-desc">{contentData.SolutionsContent.description}</p>
                            {/* </div> */}
                        </div>
                ...
                {/*  ---------------------------  */}
                {/* our process start */}
                <section id="sectors" className="mobile-spacing Business-Advisory-process tablet-spacing">
                    <div className="container-fluid Business-Advisory-process-inner">
                        <div className="row">
                            <h3 className="sub-head">/ Our Process</h3>
                            <h2 className="main-head p-xs-0">{contentData.ProcessContent.title}</h2>
                            <p className='text-desc p-xs-0'>{contentData.ProcessContent.description}</p>
                            <div className="row sectors-box">
                                {contentData.processSteps.map((step, index) => (
                                    <div key={index} className="col-lg-4 col-md-6 col-sm-6 icon-box">
                                        <img
                                            src={step.imgSrc}
                                            alt={step.alt}
                                            title={step.title}
                ...
                {/* ------------------------ */}
                {/* ask-us start */}
                <section id="ask-us" class="outsouced-bookeeping-inner bgimg mobile-spacing tablet-spacing">
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <a class="bg-remove-btn-svg" href="/contact" data-discover="true">
                                get in touch<span>  <MdArrowOutward /></span>
                            </a>
                        </div>
                    </div>
                </section>
